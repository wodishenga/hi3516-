...
static HI_VOID ISP_DgWdrModeSet(VI_PIPE ViPipe, HI_VOID *pRegCfg)
{
    ...
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.u16GainR  = u16Gain;
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.u16GainGR = u16Gain;
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.u16GainGB = u16Gain;
    pstRegCfg->stAlgRegCfg[0].stFeDgRegCfg.stDynaRegCfg.u16GainB  = u16Gain;
}
