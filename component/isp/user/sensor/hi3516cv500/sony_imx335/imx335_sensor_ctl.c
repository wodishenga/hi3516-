...
void IMX335_linear_5M30_12bit_init(VI_PIPE ViPipe)
{
    ...
    IMX335_write_register(ViPipe, 0x3030, 0x94); //VMAX_LOW
    IMX335_write_register(ViPipe, 0x3031, 0x11); //VMAX_MIDDLE
    IMX335_write_register(ViPipe, 0x3032, 0x00); //VMAX_HIGH

    IMX335_write_register(ViPipe, 0x3034, 0x26); //HMAX
    IMX335_write_register(ViPipe, 0x3035, 0x02);

    IMX335_write_register(ViPipe, 0x3058, 0x09); //SHR0
    IMX335_write_register(ViPipe, 0x3059, 0x00);
    IMX335_write_register(ViPipe, 0x305A, 0x00);

    IMX335_write_register(ViPipe, 0x30E8, 0x00); //Gain
...
void IMX335_wdr_5M30_10bit_init(VI_PIPE ViPipe)
{
    ...
    IMX335_write_register(ViPipe, 0x300C, 0x5B); //BCWAIT_TIME
    IMX335_write_register(ViPipe, 0x300D, 0x40); //CPWAIT_TIME
    IMX335_write_register(ViPipe, 0x3018, 0x00); //WINMODE
    IMX335_write_register(ViPipe, 0x302C, 0x30); ////HTRIMMING_START
    IMX335_write_register(ViPipe, 0x302D, 0x00); ////HTRIMMING_START
    IMX335_write_register(ViPipe, 0x302E, 0x38); //HNUM
    IMX335_write_register(ViPipe, 0x302F, 0x0A); //HNUM

    IMX335_write_register(ViPipe, 0x3030, 0x94); //VMAX_LOW
    IMX335_write_register(ViPipe, 0x3031, 0x11); //VMAX_MIDDLE
    IMX335_write_register(ViPipe, 0x3032, 0x00); //VMAX_HIGH

    IMX335_write_register(ViPipe, 0x3034, 0x13); //HMAX
    IMX335_write_register(ViPipe, 0x3035, 0x01);

    IMX335_write_register(ViPipe, 0x3048, 0x01); //WDMODE
    IMX335_write_register(ViPipe, 0x3049, 0x01); //WDSEL
    IMX335_write_register(ViPipe, 0x304A, 0x04); //WD_SET1
    IMX335_write_register(ViPipe, 0x304B, 0x03); //WD_SET2
    IMX335_write_register(ViPipe, 0x304C, 0x13); //OPB_SIZE_V
    IMX335_write_register(ViPipe, 0x304E, 0x00); //HREVERSE
    IMX335_write_register(ViPipe, 0x304F, 0x00); //VREVERSE

    IMX335_write_register(ViPipe, 0x3050, 0x00); //ADBIT

    IMX335_write_register(ViPipe, 0x3056, 0xAC); //Y_OUT_SIZE_LOW
    IMX335_write_register(ViPipe, 0x3057, 0x07); //Y_OUT_SIZE_HIGH

    IMX335_write_register(ViPipe, 0x3058, 0x28); //SHR0_LOW
    IMX335_write_register(ViPipe, 0x3059, 0x1F); //SHR0_MIDDLE
    IMX335_write_register(ViPipe, 0x305A, 0x00); //SHR0_HIGH

    IMX335_write_register(ViPipe, 0x305C, 0x12); //SHR1_LOW
    IMX335_write_register(ViPipe, 0x305D, 0x00); //SHR1_MIDDLE
    IMX335_write_register(ViPipe, 0x305E, 0x00); //SHR1_HIGH


    IMX335_write_register(ViPipe, 0x3068, 0x1A); //RHS1_LOW
    IMX335_write_register(ViPipe, 0x3069, 0x00); //RHS1_MIDDLE
    IMX335_write_register(ViPipe, 0x306A, 0x00); //RHS1_HIGH


    IMX335_write_register(ViPipe, 0x3072, 0x28); //AREA2_WIDTH_1
    IMX335_write_register(ViPipe, 0x3073, 0x00); //AREA2_WIDTH_1
    IMX335_write_register(ViPipe, 0x3074, 0xB0); //AREA3_ST_ADR_1
    IMX335_write_register(ViPipe, 0x3075, 0x00); //AREA3_ST_ADR_1
    IMX335_write_register(ViPipe, 0x3076, 0x58); //AREA3_WIDTH_1
    IMX335_write_register(ViPipe, 0x3077, 0x0F); //AREA3_WIDTH_1
    ...
    IMX335_write_register(ViPipe, 0x30E8, 0x00); //GAIN_LOW_LONG
    IMX335_write_register(ViPipe, 0x30E9, 0x00); //GAIN_HIGH_LONG

    IMX335_write_register(ViPipe, 0x30EA, 0x00); //GAIN1_LOW_SHORT
    IMX335_write_register(ViPipe, 0x30EB, 0x00); //GAIN1_HIGH_SHORT
    ...
    IMX335_write_register(ViPipe, 0x319E, 0x01);
    IMX335_write_register(ViPipe, 0x319F, 0x03); //virtul channel mode
    IMX335_write_register(ViPipe, 0x31A0, 0x2A); //XH&VSOUTSEL
    IMX335_write_register(ViPipe, 0x31D7, 0x01);

    IMX335_write_register(ViPipe, 0x3200, 0x00); //FGAINEN

    IMX335_write_register(ViPipe, 0x3288, 0x21);
    IMX335_write_register(ViPipe, 0x328A, 0x02);

    IMX335_write_register(ViPipe, 0x3300, 0x00); //TCYCLE
    IMX335_write_register(ViPipe, 0x3302, 0x32); //BLKLEVEL

    IMX335_write_register(ViPipe, 0x3414, 0x05);
    IMX335_write_register(ViPipe, 0x3416, 0x18);
    IMX335_write_register(ViPipe, 0x341C, 0xFF); //ADBIT1
    ...
    IMX335_write_register(ViPipe, 0x3A04, 0x48); //add
    IMX335_write_register(ViPipe, 0x3A05, 0x09); //add
