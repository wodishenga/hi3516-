...
{
    {0x0c9c, 0, 1, 10, 30,  0, "4K2K_10BIT_30FPS"  },               /* HS6  3840x2160 30fps  */
    {0x12c3, 0, 1, 10, 20,  0, "4K3K_10BIT_20FPS"  },               /* HS10 4000x3000 19.98fps*/
    {0x0641, 0, 1, 10, 60,  0, "2.7K1.5K_10BIT_60FPS"  },           /* HS8 2716x1524 59.94fps (crop)*/
    {0x0950, 0, 1, 10, 40,  1, "2.7K1.5K_10BIT_40FPS"  },           /* HS7 2716x1524 40.62fps (scaling)*/
    {0x0454, 0, 1, 10, 90,  0, "2K1K_10BIT_90FPS"  },               /* K00   HV1/2 (16:9) 1080p 90fps */
    {0x02f0, 0, 1, 10, 129, 0, "720P_10BIT_129FPS"  },              /* HS9 1280x720 128.80fps*/
    {0x0c9c, 0, 1, 10, 30,  1, "4K2K_10BIT_30FPS_SCALE"  },         /* HS6  3840x2160 30fps  */
};
...
static HI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    U32MaxFps = g_astImx458ModeTbl[pstSnsState->u8ImgMode].u32MaxFps;
    pstAeSnsDft->stIntTimeAccu.f32Offset = g_astImx458ModeTbl[pstSnsState->u8ImgMode].fOffset;
    ...
    pstAeSnsDft->u32HmaxTimes = (1000000*1000) / DIV_0_TO_1_FLOAT(u32Fll * U32MaxFps);
...
static HI_VOID cmos_fps_set(VI_PIPE ViPipe, HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    u32MaxFps = g_astImx458ModeTbl[pstSnsState->u8ImgMode].u32MaxFps;
    u32Lines = g_astImx458ModeTbl[pstSnsState->u8ImgMode].u32VMax * u32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
    pstSnsState->u32FLStd = u32Lines;
    pstAeSnsDft->u32MaxIntTime = pstSnsState->u32FLStd - g_astImx458ModeTbl[pstSnsState->u8ImgMode].u32ExpLineLimit;

    /* SHR 16bit, So limit full_lines as 0xFFFF */
    if (f32Fps > u32MaxFps || u32Lines > IMX458_FULL_LINES_MAX)
    {
...
HI_BOOL g_bLongExposure[ISP_MAX_PIPE_NUM] = {0};
HI_U32 g_u32LongExpIntTime[ISP_MAX_PIPE_NUM] = {0};
...
static HI_VOID cmos_set_pixel_detect(VI_PIPE ViPipe, HI_BOOL bEnable)
{
    ...
    if (bEnable) /* setup for ISP pixel calibration mode */
    {
        u32Again = 0;
        u32Dgain = 0x100;
        u32Vmax = g_astImx458ModeTbl[pstSnsState->u8ImgMode].u32VMax * g_astImx458ModeTbl[pstSnsState->u8ImgMode].u32MaxFps / 5;
